...
export const metadata = {
  title: 'Deposits and Progress Billing: Getting Paid Across a Multi-Day Fence Job | FenceBossPro',
  description: 'How FenceBossPro uses deposits, progress billing, and card-on-file payments to keep cash flowing through long, material-heavy multi-day fence installs.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h1>Deposits and Progress Billing: Getting Paid Across a Multi-Day Fence Job</h1>
        <p>
          A fence job is not a one-day, pay-at-the-curb transaction. You front the cost of posts, panels, pickets, rails, concrete, and gate hardware days before a single hole gets dug, and a 400-foot privacy fence might run a crew most of a week. If you wait until the last picket is hung to ask for a dime, you are financing the whole build out of your own pocket &mdash; and hoping the homeowner is happy enough to write the check. That is a bad way to run a fencing company. FenceBossPro is built to collect money the way a real install actually unfolds: a deposit up front, draws as milestones land, and a final balance at completion. Here is how the software keeps cash moving across a multi-day job.
        </p>

        <h2>Why a Fence Job Needs More Than One Payment</h2>
        <p>
