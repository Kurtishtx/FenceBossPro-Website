...
export const metadata = {
  title: 'Tracking Material Costs and Job Profitability on Every Fence Project | FenceBossPro',
  description: 'See how FenceBossPro ties posts, panels, and gate hardware to each bid so you know the real profit on every fence job before you cash the check.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h1>Tracking Material Costs and Job Profitability on Every Fence Project</h1>
        <p>
          Most fence contractors can tell you what they charged for a job. Far fewer can tell you what they actually made on it. The gap between those two numbers is where good companies quietly bleed cash &mdash; an extra pallet of pickets here, a load of concrete there, a gate that took two trips to hang. When you run wood, vinyl, chain link, aluminum, and ornamental jobs back to back, those slips add up fast. FenceBossPro is built to close that gap by tying every post, panel, rail, and bag of concrete to the bid it came from, so you see real profit on every project instead of guessing at the end of the month.
        </p>

        <h2>Your Bid Already Knows Your Costs</h2>
        <p>
          Profit tracking does not start at the invoice &mdash; it starts at the estimate. In FenceBossPro, every bid is built from line items, and every line item carries a cost as well as a price. When you add 38 line feet of 6-foot cedar privacy fence, the software pulls in the posts, panels, rails, fasteners, and concrete behind that number and stores what each piece costs you. The customer sees a clean total; you see the margin underneath it. Because the takeoff drives both the quote and the cost basis, the day you accept a job you already have a budgeted material cost to measure reality against.
        </p>

        <h2>Linear-Foot Takeoffs That Turn Into Real Material Lists</h2>
        <p>
