...
export const metadata = {
  title: 'Managing Fence Repair &amp; Gate Service Calls With Fencing Software | FenceBossPro',
  description: 'See how fencing software handles fence repair and gate service calls&mdash;fast estimates, parts tracking, dispatch, and card-on-file payments in one place.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h1>Managing Fence Repair &amp; Gate Service Calls With Fencing Software</h1>
        <p>
