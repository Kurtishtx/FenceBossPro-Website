...
export const metadata = {
  title: 'From Paper Bids to Software: How to Move Your Fence Company Off the Clipboard | FenceBossPro',
  description: 'FenceBossPro turns handwritten fence bids into line-item estimates with materials, takeoffs, deposits, scheduling, and card payments &mdash; no more clipboards.',
};
