...
export const metadata = {
  title: 'Dispatching Gate and Add-On Work Without Derailing the Fence Schedule | FenceBossPro',
  description: 'How FenceBossPro slots gate installs, repairs, and add-on work into your fence crew dispatch board without blowing up the linear-foot schedule or your margins.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h1>Dispatching Gate and Add-On Work Without Derailing the Fence Schedule</h1>
        <p>
