  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>ServiceTitan Is Built for HVAC and Plumbing.<br /><span>FenceBossPro Is Built for Lawn Care.</span></h1>
      ...
      <section>
        <div className="centered" style={{maxWidth:'900px', margin:'0 auto'}}>
          ...
          <p className="section-sub">ServiceTitan is built for enterprise HVAC. FenceBossPro is built for lawn care and pest control.</p>
        </div>
      ...
      <div className="premium-band">
        <h2>ServiceTitan Was Built for $5M+ HVAC Companies.<br /><span>FenceBossPro Was Built for Spray Routes.</span></h2>
        <p>ServiceTitan is one of the most powerful field service platforms in the world. It&apos;s also one of the most expensive, most complex, and most overkill tools you could choose for a lawn care or pest control business. You&apos;d spend 90 days implementing it, pay $300–$500+/month, and still be missing features built specifically for spray businesses. FenceBossPro is $129, set up in an afternoon, and built around how your routes actually work.</p>
        ...
        <div className="highlight-row">
          ...
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">FenceBossPro</div><div className="mock-sub">Every feature — built for spray routes</div></div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>ServiceTitan implementations take months, require training, and need ongoing support. FenceBossPro is designed for spray business owners who want to be running today — not next quarter after a paid onboarding engagement.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>No Onboarding Team Required</h3><p>FenceBossPro is designed to be self-serve from day one. Add your services, import your clients and properties, connect your payment processor, and you&apos;re scheduling. No implementation consultant, no 90-day setup timeline.</p></div>
