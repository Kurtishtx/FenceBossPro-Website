...
const faqs = [
  ...
  { q: "What's the SMS pricing?", a: 'In the US and Canada, 500 texts per month — sent and received — are included in your $129. If you go over, you can add blocks of 500 for $15 each. Most businesses with under 300 active properties never hit the 500 limit.' },
  ...
  { q: 'What if I have questions or need help getting set up?', a: "We're a small team and we respond fast. Reach us anytime at Support@bossprohq.com. We've installed fence ourselves — we know what setup actually looks like and we're here to help." },
];
...
export default function Pricing() {
  ...
  return (
    <>
      ...
      {/* PRICE CARD */}
      <section>
        <div style={{background:'#fff',border:'3px solid var(--orange)',borderRadius:'20px',padding:'52px 48px',maxWidth:'620px',margin:'0 auto',position:'relative',boxShadow:'0 0 0 6px rgba(43,108,163,.1), 0 24px 80px rgba(15,23,32,.12)'}}>
      ...
      {/* PAIN BAND */}
      <div style={{background:'linear-gradient(135deg,#0f1720 0%,#1f2d3d 100%)',padding:'80px 40px',textAlign:'center'}}>
      ...
      <div className="cta-band">
        ...
        <p>14 days of full access — every feature, unlimited everything. See if FenceBossPro fits your operation before you spend a dollar.</p>
        <div className="hero-btns">
